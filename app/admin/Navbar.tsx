...
import { addIcon, addPersonIcon, analyticsIcon, calenderIcon, mailIcon, searchIcon ,addMovementIcon} from "../../assets/icons";
...
function Navbar() {
  ...
  const options = [
    ...
    { icon: addMovementIcon, route: "manage-movement", value: "Manage Movement"},
