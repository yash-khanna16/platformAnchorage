      ...
      {loading ? (
        ...
        <div className=' m-5 rounded-xl p-5'>
            ...
            <div className='w-1/2 p-3 shadow-md  rounded-xl border text-xl text-center'>
              ...
              <div className="flex justify-between text-lg">
                <div className='flex items-center flex-col'>
                  <div className='py-[10px] px-[8px] my-2 bg-[#4ca6e6] rounded-full text-white'>{bookings}</div>
          ...
          <div className='flex justify-between gap-5 mt-5'>
            <div className='w-1/2 shadow-md  border flex items-center rounded-xl '>
            ...
            <div className='w-1/2 '>
              <div className='mb-5 p-3 shadow-md  border rounded-xl'>
                <LineChart chartData={roomData} title="Rooms Booked Per Day" />
              </div>
              <div className='mt-5 p-3 shadow-md  border rounded-xl'>
                <LineChart chartData={mealData} title="Meals Served Per Day" />
              </div>
            </div>
          </div>
        </div>
