                                ...
                                <>
                                  <View>
                                    <View style={{ display: "flex", flexDirection: "row", borderBottom: 1 }}>
                                      ...
                                      <View style={{ width: "100%", padding: 5, borderRight: 1 }}>
                                        <Text>{convertDateFormat(data.pickup_time.split("T")[0]) + ' ' + pickup_time.split(":")[0]+':'+pickup_time.split(":")[1] }</Text>
                                      </View>
                                      <View style={{ width: "100%", padding: 5 }}>
                                    ...
                                    <View style={{ display: "flex", flexDirection: "row", borderBottom: 1 }}>
                                      ...
                                      <View style={{ width: "100%", padding: 5, borderRight: 1 }}>
                                      <Text>{convertDateFormat(data.return_time.split("T")[0]) + ' ' + return_time.split(":")[0]+':'+return_time.split(":")[1] }</Text>
                                      </View>
                                      <View style={{ width: "100%", padding: 5 }}>
